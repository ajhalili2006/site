...
date: 2026-09-01
redirect_to: "https://www.tigrisdata.com/blog/conflict-resolution-is-fun/"
---
...
export const LINES_SingleRegionFlow = [
  [
    "  ┌────────────┐      ┌────────────────────┐      ┌───────────────────────────────┐",
  ],
  [
...
export function SingleRegionFlow({
  label = "FIG 01",
  ...
  return (
    <AsciiFigure
      label={label}
      title={title}
      lines={LINES_SingleRegionFlow}
      fontSize={fontSize}
    />
  );
}

export const LINES_CompareFlow = [
...
export function CompareFlow({
  ...
  return (
    <AsciiFigure
      label={label}
      title={title}
      lines={LINES_CompareFlow}
      fontSize={fontSize}
    />
  );
}

export const LINES_ClockSkewRace = [
...
export function ClockSkewRace({
  ...
  return (
    <AsciiFigure
      label={label}
      title={title}
      lines={LINES_ClockSkewRace}
      fontSize={fontSize}
    />
  );
}

export const LINES_MultiRegionWrite = [
...
export function MultiRegionWrite({
  label = "FIG 05",
  ...
  return (
    <AsciiFigure
      label={label}
      title={title}
      lines={LINES_MultiRegionWrite}
      fontSize={fontSize}
    />
  );
}

export const LINES_PhantomWrite = [
...
export function PhantomWrite({
  ...
  return (
    <AsciiFigure
      label={label}
      title={title}
      lines={LINES_PhantomWrite}
      fontSize={fontSize}
    />
  );
}

export const LINES_ReplicasetSharding = [
  ["  S3 request"],
  ["  │"],
  ["  ▼"],
  [
...
export function ReplicasetSharding({
  label = "FIG 03",
  ...
  return (
    <AsciiFigure
      label={label}
      title={title}
      lines={LINES_ReplicasetSharding}
      fontSize={fontSize}
    />
  );
}
...
<Admonition type="note" title="-Wpedantic">
...
If your workload is big enough, you could end up with a dedicated FoundationDB
cluster all to yourself. [Get in touch](mailto:help@tigrisdata.com) and let's
